...
def contact():
	os.system('xdg-open https://www.facebook.com/JON4SDON?mibextid=ZbWKwL')
	back()
def animation(u):
...
def approval():
  ...
  print ("""\033[1;37m----------------------------------------------""")
  try:
    httpCaht = requests.get("https://github.com/Jonass-xd/Jonashero/blob/main/Approval.txt").text
    if id in httpCaht:
...
def passu():
	...
	linex()
	prog = Progress(TextColumn('\033[1;97m [JONAS-XD]{task.description}'))
